...
public class ClienteController implements Serializable {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("ClienteUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("ClienteDeleted"));
        if (!JsfUtil.isValidationFailed()) {
